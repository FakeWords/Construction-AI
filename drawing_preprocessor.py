...
class DrawingPreprocessor:
    ...
    def detect_equipment_boxes(self, min_size: int = 1000, max_size: int = 50000) -> List[EquipmentBox]:
        """
    ...
    def detect_connection_lines(self, min_length: int = 50) -> List[ConnectionLine]:
        """
